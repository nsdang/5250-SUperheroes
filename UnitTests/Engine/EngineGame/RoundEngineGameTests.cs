...
namespace UnitTests.Engine.EngineGame
{
    ...
    public class RoundEngineGameTests
    {
        ...
        [Test]
        public void RoundEngine_RoundNextTurn_Valid_Characters_Monsters_AutoBattle_Should_Return_NewRound()
        {
            Engine.EngineSettings.MonsterList.Clear();
        ...
        [Test]
        public void RoundEngine_RoundNextTurn_Valid_Characters_Monsters_SpecialAttack_Should_Return_NextTurn()
        {
            Engine.EngineSettings.MonsterList.Clear();
            ...
            // Act
            var result = Eng.RoundNextTurn(2);
        ...
        [Test]
        public void RoundEngine_AddMonstersToRound_Round_DivisbleBy3_Valid_Default_Should_Pass()
        {
            // Arrange
