...
namespace UnitTests.Engine.EngineGame
{
    ...
    public class TurnEngineKoenigTests
    {
        ...
        [Test]
        public void TurnEngine_Attack_WhenModerate_Valid_Correct_List_Should_Pass()
        {
            // Arrange
            var PlayerInfo = new PlayerInfoModel();
            Engine.EngineSettings.MonsterList.Add(new PlayerInfoModel(new MonsterModel()));
        ...
        [Test]
        public void TurnEngine_Attack_WhenSpecial_Valid_Correct_List_Should_Pass()
        {
            // Arrange
            var PlayerInfo = new PlayerInfoModel();
            Engine.EngineSettings.MonsterList.Add(new PlayerInfoModel(new MonsterModel()));
        ...
        {
            // Arrange
            MonsterModel vet = Game.GameRules.DefaultData.LoadData(new MonsterModel()).Find(n => n.Job.Equals(CharacterJobEnum.Vet));
            PlayerInfoModel playerVet = new PlayerInfoModel(vet);
            playerVet.Alive = false;
            // Act
            var result = Engine.Round.Turn.DropItems(playerVet);
        ...
        */
        ...
        [Test]
        public void TurnEngine_TurnAsModerateAttack_Valid_Character_Attacks_NotNull_Should_Pass()
        {
            // Arrange
            var Character = new CharacterModel();
            var CharacterPlayer = new PlayerInfoModel(Character);
            ...
            // Act
            var result = Eng.TurnAsModerateAttack(MonsterPlayer, CharacterPlayer);
        ...
        [Test]
        public void TurnEngine_TurnAsSpecialAttack_Valid_Attacker_Flying_Job_Should_Pass()
        {
            // Arrange
            var Character = new CharacterModel();
            Character.Job = CharacterJobEnum.Flying;
            ...
            // Act
            var result = Eng.TurnAsSpecialAttack(CharacterPlayer, MonsterPlayer);
